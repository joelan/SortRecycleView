...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int mTitleTextColor = TITLE_TEXT_COLOR;
    private int mTitleTextBgColor = TITLE_BG_COLOR;

    int titilepaddingleft;
    Context context;


    private TitleItemDecoration(Context context, List<SortModel> data) {
        super();
        mData = data;
        mPaint = new Paint();
        mBounds = new Rect();
    ...
    public TitleItemDecoration(Builder builder) {
        super();
        //mData = data;
        mPaint = new Paint();
        mBounds = new Rect();
...
//        mTitleTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 16, context.getResources().getDisplayMetrics());
        ...
        this.mTitleTextBgColor = builder.mTitleTextBgColor;
        this.mTitleTextColor = builder.mTitleTextColor;
        this.mTitleTextSize = builder.mTitleTextSize;
        this.mData = builder.mData;
        context = builder.context;
        titilepaddingleft = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics());
        mPaint.setTextSize(mTitleTextSize);
    ...
    public static class Builder<T> {
        ...
        private int mTitleTextColor = Color.parseColor("#FFDFDFDF");
        private int mTitleTextBgColor = Color.parseColor("#FF000000");
        Context context;
        private int mTitleTextSize;
        private int mTitleHeight;

        private List<SortModel<T>> mData;

        public Builder(Context context, List<SortModel<T>> Data) {
        ...
        public Builder setTitileTextColor(int mTitleTextColor) {
        ...
        public Builder setTitleTextBgColor(int mTitleTextBgColor) {

            this.mTitleTextBgColor = mTitleTextBgColor;
        ...
        public Builder setmTitleHeight(int mTitleHeight) {
        ...
        public TitleItemDecoration build() {
            return new TitleItemDecoration(this);
        }
    ...
    private void drawTitle(Canvas c, int left, int right, View child, RecyclerView.LayoutParams params, int position) {
        mPaint.setColor(mTitleTextBgColor);
        ...
        Log.i("draw", mData.get(position).getLetters());
        c.drawText(mData.get(position).getLetters(),
                child.getPaddingLeft() + titilepaddingleft,
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {
        ...
        c.drawText(tag, child.getPaddingLeft() + titilepaddingleft,
